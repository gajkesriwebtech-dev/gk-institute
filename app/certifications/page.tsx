...
const CertificationsPage = () => {
    ...
    const certificationCourses = [
        {
            ...
            icon: '📱',
            image: cld("courses/digital-marketing", 600),
            title: 'Digital Marketing Certification',
            description: 'Complete digital marketing course covering SEO, SMM, PPC, and Content Strategy',
            duration: '5-6 Months',
            level: 'Beginner to Advanced',
            price: `₹${getBasePrice('digital-marketing').toLocaleString('en-IN')}`,
            color: 'from-purple-500 to-pink-500',
            href: '/courses/digital-marketing',
            tools: ["OpenAI", "Gemini", "Python"]
        },
        {
            id: 'seo-content',
            icon: '🔍',
            ...
            description: 'Dominate search rankings with Technical SEO, Keyword Research, and Content Optimization',
            duration: '5 Months',
            level: 'Professional',
            price: '₹24,999',
        ...
        },
        {
            id: 'ui-ux-design',
            icon: '✨',
            image: cld("courses/ui-ux-design", 600),
            title: 'UI/UX Design Certification',
            description: 'Design digital products with user research, wireframing, and prototyping',
            duration: '6 Months',
            level: 'Beginner to Intermediate',
            price: `₹${getBasePrice('ui-ux-design').toLocaleString('en-IN')}`,
    ...
    const benefits = [
        { icon: '✓', title: '100% Placement Assistance', description: 'Dedicated career support and job placement' },
        { icon: '✓', title: 'Industry-Recognized Certificates', description: 'Valued by top companies worldwide' },
        { icon: '✓', title: 'Lifetime Access', description: 'Access course materials forever' },
        { icon: '✓', title: 'Expert Mentorship', description: 'Learn from industry professionals' },
        { icon: '✓', title: 'Real-World Projects', description: 'Build portfolio-worthy projects' },
        { icon: '✓', title: 'Flexible Learning', description: 'Study at your own pace' }
    ];
    ...
    const testimonials = [
        {
            ...
            image: cld("testimonials/student-a", 200),
            quote: 'The Digital Marketing certification transformed my career. I mastered SEO and PPC, and got placed in my dream company within 2 months!'
        },
        {
            name: 'Priya Patel',
            role: 'SEO Specialist',
            company: 'Marketing Agency',
            image: cld("testimonials/student-b", 200),
            quote: 'The SEO & Content certification gave me practical skills. I now rank websites on page 1 of Google. Highly recommend!'
        }
    ];

    const certificationSteps = [
        { step: '1', title: 'Enroll in Course', description: 'Choose your certification program' },
        { step: '2', title: 'Complete Modules', description: 'Learn through video lessons and assignments' },
        { step: '3', title: 'Build Projects', description: 'Work on real-world projects' },
        { step: '4', title: 'Pass Assessment', description: 'Complete final certification exam' },
        { step: '5', title: 'Get Certified', description: 'Receive your industry-recognized certificate' }
    ];
    ...
    return (
        <PublicLayout>
            ...
            <section id="verify-certificate" className="py-24 bg-white dark:bg-slate-950 transition-colors duration-300 border-t border-slate-100 dark:border-slate-800">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-12 border-2 border-slate-200 dark:border-slate-800 shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-2 h-full bg-[#1F4037]"></div>
                        <div className="w-20 h-20 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center mx-auto mb-8 border border-slate-100 dark:border-slate-700 shadow-premium">
                            <Icons.CheckCircle className="w-10 h-10 text-emerald-500" />
                        </div>
                        <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-4 uppercase tracking-tight">
                            Verify Authenticity
                        </h2>
                        <p className="text-lg text-slate-500 dark:text-slate-400 mb-10 font-medium">
                            Enter the unique ID from your GK Institute certificate to verify its validity and view the student portfolio.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                            <input
                                type="text"
                                placeholder="e.g., GKI-FS-2026-0892"
                                className="flex-1 px-6 py-4 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-[#FDB827] focus:outline-none font-bold tracking-widest"
                            />
                            <Button variant="marigold" size="lg" className="px-10">
                                Verify Now
                            </Button>
                        </div>
                    </div>
            ...
            {/* SECTION: Student Portfolio Showcase */}
